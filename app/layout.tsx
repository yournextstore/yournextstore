...
import { Archivo_Black, DM_Serif_Display, Inter } from "next/font/google";
...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription =
		...
		"The laundry essentials you've been wishing for — good for you, your clothes, and the planet.";
...
export default async function RootLayout({
	...
	return (
		<html lang={lang}>
			<body className={`${sans.variable} ${display.variable} ${script.variable} antialiased`}>
