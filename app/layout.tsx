...
function AnnouncementBar() {
	return (
		<div className="relative z-40 border-b border-foreground/10 bg-ink">
			<div className="mx-auto flex h-8 max-w-[1600px] items-center justify-center px-4 text-[10px] tracking-microcaps text-foreground/70">
				Complimentary shipping & samples on orders $30+
			</div>
		</div>
	);
}
					...
					<div className="mx-auto max-w-[1600px] px-5 sm:px-8 lg:px-12">
						<div className="grid h-16 grid-cols-[1fr_auto_1fr] items-center gap-4">
							...
							<YnsLink
								prefetch={"eager"}
								href="/"
								className="font-serif-display text-3xl font-medium tracking-wide text-foreground"
							>
								Your Next Store
							</YnsLink>
