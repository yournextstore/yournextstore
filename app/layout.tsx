...
function AnnouncementBar() {
	return (
		<div className="bg-[var(--color-yellow)] text-[var(--color-navy)]">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-center gap-3 py-2 text-center text-xs sm:text-sm font-medium tracking-wide">
					<span aria-hidden className="hidden sm:inline-block">
						✦
					</span>
					<p>
						NEW <span className="font-bold">YNS Refresh 7 oz</span> — our biggest (and most refreshing) size
						yet
					</p>
					<span aria-hidden className="hidden sm:inline-block">
						✦
	...
	return (
		<CartProvider initialCart={cart} initialCartId={cartId}>
			<div className="flex min-h-screen flex-col">
				<AnnouncementBar />
				<header className="sticky top-0 z-50 bg-[var(--color-sky)] text-[var(--color-navy)]">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="grid grid-cols-2 lg:grid-cols-[1fr_auto_1fr] items-center h-16 gap-4">
							...
							<YnsLink
								prefetch={"eager"}
								href="/"
								className="justify-self-start lg:justify-self-center font-display text-xl sm:text-2xl font-extrabold tracking-[0.18em] uppercase text-white drop-shadow-sm"
							>
								Your Next Store
							</YnsLink>
