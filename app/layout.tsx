...
export async function generateMetadata(): Promise<Metadata> {
	...
	const storeName = me.store.settings?.storeName || "Kids Wonder Shop - Amazing Stuff for Amazing Kids!";
	...
	return {
		...
		description:
			...
			"Discover super cool toys, games, and awesome goodies for kids of all ages!",
		icons: {
			icon: [
