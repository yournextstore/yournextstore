...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription =
		me.store.settings?.storeDescription || "Salon-grade haircare, bottled for your future hair.";
...
function AnnouncementBar() {
	return (
		<div className="bg-yns-pink text-yns-ink text-[11px] tracking-[0.18em] uppercase font-medium">
			<div className="max-w-7xl mx-auto px-4 py-2.5 text-center">
				For Your Future Hair — New year care designed to protect what&apos;s next. 15% off + complimentary YNS
				Comb on $75+. Just add to cart.
			</div>
		</div>
	);
}
						...
						<div className="grid grid-cols-3 items-center h-16 sm:h-20">
							...
							<div className="flex items-center justify-center">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="yns-logo text-2xl sm:text-3xl tracking-wider text-yns-ink"
...
export default async function RootLayout({
	...
	return (
		<html lang={lang}>
			<body className={`${bodoni.variable} ${spaceGrotesk.variable} antialiased`}>
