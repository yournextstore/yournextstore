...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription =
		me.store.settings?.storeDescription || "Salon-inspired care, reimagined for texture-rich hair.";
						...
						<div className="grid grid-cols-3 items-center h-16">
							...
							<div className="flex justify-center">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="font-serif text-3xl sm:text-[2rem] font-medium tracking-tight text-foreground leading-none whitespace-nowrap"
								>
									Your Next Store
								</YnsLink>
							</div>
