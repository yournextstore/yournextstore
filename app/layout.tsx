...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription =
		me.store.settings?.storeDescription || "Botanical-grade skincare, formulated for results.";
						...
						<div className="grid grid-cols-3 items-center h-16">
							...
							<div className="flex justify-center">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="uppercase-display text-[15px] sm:text-base tracking-[0.18em] font-medium text-foreground"
								>
									Your Next Store
								</YnsLink>
							</div>
...
export default async function RootLayout({
	...
	return (
		<html lang={lang}>
			<body className={`${inter.variable} ${display.variable} ${geistMono.variable} antialiased`}>
