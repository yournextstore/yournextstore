...
function AnnouncementBar() {
	return (
		<div className="bg-[#3B3A33] text-[#E8DFD3]">
			<div className="mx-auto flex max-w-7xl items-center justify-center px-4 py-2 text-center text-[11px] tracking-[0.18em] uppercase">
				complimentary bandana &nbsp;·&nbsp; free shipping on orders over $75
			</div>
		</div>
	);
}
						...
						<div className="grid h-16 grid-cols-3 items-center">
							...
							<div className="flex justify-center">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="font-serif text-[20px] sm:text-[22px] font-medium yns-letter-spacing-mid text-foreground"
								>
									YOUR&nbsp;&nbsp;NEXT&nbsp;&nbsp;STORE
								</YnsLink>
							</div>
