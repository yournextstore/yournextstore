...
function AnnouncementBar() {
	return (
		<div className="w-full bg-[color:var(--yns-cream-deep)] text-foreground">
			<div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-2 flex items-center justify-center text-center text-xs sm:text-sm">
				<span className="font-medium">
					Free shipping worldwide on orders over €300.{" "}
					<YnsLink
						prefetch="eager"
						href="/products"
						className="text-[color:var(--yns-terracotta)] hover:underline underline-offset-2 font-semibold"
					>
						Shop now
					</YnsLink>
				</span>
					...
					<div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
						<div className="flex items-center justify-between h-14 sm:h-16">
							...
							<YnsLink
								...
								className="sm:hidden font-display text-lg tracking-tight"
							>
								YNS
							</YnsLink>
