...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription =
		me.store.settings?.storeDescription || "The nightly ritual for the sleep you've been missing.";
...
function AnnouncementBar() {
	return (
		<div className="announcement-bar text-[11px] tracking-[0.2em] uppercase text-cream/95">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 text-center font-medium">
				30% off your first subscription · free shipping over $50
			</div>
		</div>
	);
}
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="grid grid-cols-[1fr_auto_1fr] items-center h-16 gap-6">
							<YnsLink
								prefetch={"eager"}
								href="/"
								className="justify-self-start text-[15px] font-serif font-bold tracking-[0.18em] uppercase text-primary leading-tight"
							>
