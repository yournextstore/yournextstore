	...
	return (
		<CartProvider initialCart={cart} initialCartId={cartId}>
			<div className="flex min-h-screen flex-col">
				<div className="bg-[color:var(--yns-ink)] text-white">
					<div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-2 flex items-center justify-center gap-2 text-[11px] font-bold tracking-[0.16em] uppercase">
						<span className="text-[color:var(--yns-pink)]">✦</span>
						<span>Free shipping over $60 — Good hair days, delivered</span>
						<span className="text-[color:var(--yns-pink)]">✦</span>
					</div>
				</div>
				<header className="sticky top-0 z-50 border-b border-[color:var(--yns-ink)]/10 bg-[color:var(--yns-cream)]/95 backdrop-blur-md">
						...
						<div className="flex items-center justify-between h-20">
							<div className="flex items-center gap-10">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="font-script text-4xl leading-none text-[color:var(--yns-red)] -rotate-3 hover:rotate-0 transition-transform"
								>
									Your Next Store
								</YnsLink>
								<Navbar links={links} />
...
export default async function RootLayout({
	...
	return (
		<html lang={lang}>
			<body className={`${inter.variable} ${anton.variable} ${caveat.variable} antialiased`}>
