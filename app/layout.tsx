...
async function getStoreMetadata(): Promise<Metadata> {
	...
	const storeDescription = me.store.settings?.storeDescription || "Intimate by nature. Intuitive by design.";
						...
						<div className="grid grid-cols-3 items-center h-20">
							<div className="flex items-center">
								<YnsLink
									prefetch={"eager"}
									href="/"
									className="font-serif text-2xl sm:text-3xl tracking-[0.18em] text-foreground"
								>
									YOUR NEXT STORE
								</YnsLink>
							</div>
