			...
			<nav className="hidden md:flex items-center gap-6">
				{links.map((link) => (
					<YnsLink
						...
						prefetch="eager"
						href={link.href}
						className="inline-flex items-center rounded-full border border-border bg-background px-4 py-2 text-sm font-medium text-foreground whitespace-nowrap hover:bg-accent transition-colors"
					>
						{link.label}
					</YnsLink>
				))}
