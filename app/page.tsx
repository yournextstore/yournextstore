...
function PromoBanner() {
	return (
		<section className="relative w-full h-[50vh] sm:h-[60vh] overflow-hidden">
			<Image src="/scraped-6.jpg" alt="New arrivals" fill className="object-cover" sizes="100vw" />
...
function GiftCardBanner() {
	return (
		<section className="relative w-full h-[50vh] sm:h-[60vh] overflow-hidden">
			<Image src="/scraped-8.jpg" alt="Gift cards" fill className="object-cover" sizes="100vw" />
				...
				<div className="grid grid-rows-2 h-[60vh] lg:h-[80vh]">
						...
						<div className="text-center">
							...
							<div className="mt-4 flex gap-3 justify-center">
								<div className="w-16 h-20 bg-secondary overflow-hidden relative">
									<Image src="/scraped-0.jpg" alt="Sale" fill className="object-cover" sizes="64px" />
								</div>
								<div className="w-16 h-20 bg-secondary overflow-hidden relative">
									<Image src="/scraped-1.jpg" alt="Sale" fill className="object-cover" sizes="64px" />
								</div>
							</div>
						</div>
					</YnsLink>
					...
					>
						<div className="text-center">
							...
							<div className="mt-4 flex gap-3 justify-center">
								<div className="w-16 h-20 bg-secondary overflow-hidden relative">
									<Image src="/scraped-2.jpg" alt="Sale" fill className="object-cover" sizes="64px" />
								</div>
								<div className="w-16 h-20 bg-secondary overflow-hidden relative">
									<Image src="/scraped-3.jpg" alt="Sale" fill className="object-cover" sizes="64px" />
								</div>
							</div>
						</div>
					</YnsLink>
...
function ShopByCategory() {
	const categories = [
		{ name: "Tops", image: "/scraped-11.jpg", href: "/collection/all" },
		{ name: "Tunics", image: "/scraped-12.jpg", href: "/collection/all" },
		{ name: "Dresses", image: "/scraped-13.jpg", href: "/collection/all" },
		{ name: "Accessories", image: "/scraped-14.jpg", href: "/collection/all" },
	];
...
function JournalSection() {
	const posts = [
		{ title: "Looks we love", date: "May 10, 2024", image: "/scraped-4.jpg" },
		{ title: "10 ways to unwind", date: "May 01, 2024", image: "/scraped-5.jpg" },
		{ title: "Featured designer: Bethany Jones", date: "Apr 30, 2024", image: "/scraped-9.jpg" },
	];
