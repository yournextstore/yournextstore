			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="py-14 sm:py-20 lg:py-24">
					<div className="max-w-2xl">
						<h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-light tracking-wide text-foreground">
							{collection.name}
						</h1>
			...
			{collection.image && (
				<div className="absolute top-0 right-0 w-1/2 h-full hidden lg:block">
					<YNSImage
						...
						priority
					/>
					<div className="absolute inset-0 bg-linear-to-r from-[#f5f5f0] to-transparent" />
				</div>
			)}
		</section>
	);
