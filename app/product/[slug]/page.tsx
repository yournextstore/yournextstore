			...
			<div className="lg:grid lg:grid-cols-2 lg:gap-12">
				...
				<div className="mt-8 lg:mt-0 space-y-6">
					...
					<div className="space-y-3">
						<h1 className="font-[family-name:var(--font-heading)] text-2xl sm:text-3xl lg:text-4xl font-bold uppercase tracking-tight text-foreground text-balance">
							{product.name}
						</h1>
						<p className="text-2xl font-bold text-primary tracking-tight">{priceDisplay}</p>
						{product.summary && (
							<p className="text-muted-foreground leading-relaxed text-sm">{product.summary}</p>
						)}
					</div>
