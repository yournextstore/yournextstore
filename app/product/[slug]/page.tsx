			...
			<div className="lg:grid lg:grid-cols-2 lg:gap-16">
				...
				<div className="mt-8 lg:mt-0 space-y-6">
					<div className="space-y-4">
						<h1 className="font-heading text-3xl sm:text-4xl font-light tracking-tight text-foreground">
							{product.name}
						</h1>
						<p className="text-lg font-medium tracking-tight">{priceDisplay}</p>
						{product.summary && (
							<p className="text-sm text-foreground/60 leading-relaxed">{product.summary}</p>
						)}
					</div>
