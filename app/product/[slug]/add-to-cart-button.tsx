		...
		<div className="space-y-8">
			...
			<form onSubmit={handleSubmit}>
				<button
					...
					className="w-full h-14 bg-foreground text-primary-foreground py-4 px-8 text-xs tracking-[0.2em] uppercase hover:bg-foreground/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
					{buttonText}
				</button>
			</form>
