		...
		<div className="space-y-6">
			...
			<form onSubmit={handleSubmit}>
				<button
					...
					className="w-full h-12 bg-foreground text-primary-foreground px-8 text-sm font-medium uppercase tracking-widest hover:bg-foreground/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
					{buttonText}
				</button>
			</form>
