		...
		<div className="space-y-6">
			...
			<form onSubmit={handleSubmit}>
				<button
					...
					className="w-full h-12 bg-foreground text-primary-foreground py-3 px-8 text-xs tracking-[0.2em] uppercase font-medium hover:bg-foreground/85 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
					{buttonText}
				</button>
			</form>
