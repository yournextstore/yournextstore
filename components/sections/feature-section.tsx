			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
					...
					<div className="space-y-10">
						<FeatureItem icon="/scraped-12.jpg" title="Durable powder-coated body finish" />
						<FeatureItem icon="/scraped-13.jpg" title="Soft rubber base for quiet placement" />
					</div>
					...
					{/* Right features */}
					<div className="space-y-10">
						<FeatureItem icon="/scraped-14.jpg" title="Double-walled insulation keeps drinks hot" />
						<FeatureItem icon="/scraped-12.jpg" title="2-in-1 switch functions as both cup and lid" />
					</div>
				</div>
			</div>
		</section>
