	...
	return (
		<section id="products" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
			<div className="flex items-end justify-between mb-10">
				<div>
					<h2 className="font-heading text-3xl sm:text-4xl font-light text-foreground">{title}</h2>
				...
				{showViewAll && (
					<YnsLink
						prefetch="eager"
						href={viewAllHref}
						className="hidden sm:inline-flex items-center gap-1 text-xs font-medium tracking-[0.15em] uppercase text-muted-foreground hover:text-foreground transition-colors"
					>
						View all
			...
			{showViewAll && (
				<div className="mt-12 text-center sm:hidden">
					<YnsLink
						prefetch="eager"
						href={viewAllHref}
						className="inline-flex items-center gap-1 text-xs font-medium tracking-[0.15em] uppercase text-muted-foreground hover:text-foreground transition-colors"
					>
						View all products
						<ArrowRight className="h-3.5 w-3.5" />
					</YnsLink>
