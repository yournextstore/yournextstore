			...
			<div className="relative w-full max-w-7xl mx-auto px-8 lg:px-16">
				<div className="py-24 lg:py-40 grid lg:grid-cols-12 gap-8 lg:gap-16 items-end">
					...
					<div className="lg:col-span-7">
						{/* Small caps eyebrow */}
						<p className="text-xs tracking-[0.3em] uppercase text-zinc-400 mb-12">Est. 2024</p>
						...
						<div className="mt-16 max-w-md">
							<p className="text-base text-zinc-500 leading-relaxed font-light">
								Thoughtfully crafted furniture for contemporary spaces. Timeless designs that blend form and
								function for everyday comfort.
							</p>
						</div>
					...
					<div className="lg:col-span-5 flex items-end justify-end">
						<YnsLink
							href={firstProduct ? `/product/${firstProduct.slug}` : "#products"}
				...
				<div className="absolute bottom-8 left-8 lg:left-16 right-8 lg:right-16 flex justify-between items-end">
					...
					<p className="text-xs tracking-[0.2em] uppercase text-zinc-400">Scroll</p>
				</div>
			</div>
		</section>
	);
