...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group block">
			<div className="relative aspect-square bg-fizz-aqua/40 rounded-[1.75rem] overflow-hidden mb-4 sticker-shadow">
				{singleVariant && (
					<QuickAddButton
			...
			<div className="space-y-1 px-1">
				<h3 className="text-base font-bold text-fizz-ink uppercase tracking-tight leading-snug">
					{product.name}
				</h3>
				<p className="text-base font-bold text-fizz-berry">{priceDisplay}</p>
			</div>
		</YnsLink>
	);
}
