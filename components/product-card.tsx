	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group block">
			...
			<div className="text-center">
				<h3 className="font-serif text-lg text-foreground leading-tight">{product.name}</h3>
				{priceDisplay && <p className="mt-2 text-sm tracking-wide text-foreground/70">{priceDisplay}</p>}
			</div>
		</YnsLink>
	);
}
