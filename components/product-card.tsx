...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group">
			<div className="relative aspect-[4/5] bg-sand rounded-sm overflow-hidden mb-4">
				{singleVariant && (
					<QuickAddButton
			...
			<div className="space-y-1 text-center">
				<h3 className="font-serif text-base text-foreground tracking-wide">{product.name}</h3>
