...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group block">
			<div className="relative aspect-square bg-[var(--cream)] rounded-xl overflow-hidden mb-3">
				{singleVariant && (
					<QuickAddButton
			...
			<div className="space-y-1 px-1">
				<h3 className="font-display uppercase tracking-tight text-[var(--burgundy)] text-base leading-tight line-clamp-2">
					{product.name}
				</h3>
				<p className="text-sm font-semibold text-[var(--pink)]">{priceDisplay}</p>
			</div>
		</YnsLink>
	);
}
