...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group block">
			<div className="relative aspect-[4/5] bg-[var(--yns-cream)] overflow-hidden mb-5 border border-[var(--yns-ink)]/5">
				{singleVariant && (
					<QuickAddButton
				...
				<div className="absolute top-3 right-3 yns-keep-case text-[10px] uppercase tracking-[0.25em] bg-[var(--yns-ink)] text-[var(--yns-cream)] px-2 py-1">
					new
				</div>
			</div>
			<div className="flex items-baseline justify-between gap-3">
				<h3 className="text-sm sm:text-base text-[var(--yns-ink)] group-hover:text-[var(--yns-red)] transition-colors lowercase">
					{product.name.toLowerCase()}
				</h3>
				<p className="text-sm sm:text-base text-[var(--yns-ink)] tabular-nums whitespace-nowrap">
					{priceDisplay}
				</p>
			</div>
			<p className="mt-1 text-xs text-[var(--yns-ink)]/55 lowercase">a soft ritual · 30 strips</p>
		</YnsLink>
	);
}
