...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group">
			<div className="relative aspect-[4/5] bg-[color:var(--color-blush)]/40 overflow-hidden mb-5">
				{singleVariant && (
					<QuickAddButton
			...
			<div className="space-y-1.5">
				<h3 className="text-[0.78rem] tracking-[0.18em] uppercase font-semibold text-foreground">
					{product.name}
				</h3>
				<p className="text-sm text-foreground/70">{priceDisplay}</p>
			</div>
		</YnsLink>
	);
}
