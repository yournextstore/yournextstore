...
export function ProductCard({
	...
	return (
		<YnsLink prefetch={"eager"} href={`/product/${product.slug}`} className="group block">
			<div className="relative aspect-[4/5] bg-[#ede4d3] overflow-hidden mb-5">
				{singleVariant && (
					<QuickAddButton
			...
			<div className="text-center space-y-2">
				<h3 className="font-serif text-lg sm:text-xl text-foreground tracking-[-0.01em]">{product.name}</h3>
				<p className="text-[12px] tracking-[0.18em] uppercase text-foreground/60 font-light">
					{priceDisplay}
				</p>
			</div>
		</YnsLink>
