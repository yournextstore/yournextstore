	...
	return (
		<a
			...
			className={cn(
				...
				"items-center gap-1.5 px-3 py-1.5 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700 rounded-md shadow-sm text-xs font-medium text-neutral-600 dark:text-neutral-300 transition-all duration-200 hover:shadow-md hover:scale-101 no-underline",
			)}
		>
			<svg aria-hidden="true" className="size-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 740 740">
